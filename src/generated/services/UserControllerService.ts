...
export class UserControllerService {
     ...
     * @throws ApiError
     */
    public static getUserasdsaAvatarUsingPost(): CancelablePromise<BaseResponse_string_ | any> {
     ...
     * @throws ApiError
     */
    public static getUserAvatarUsingGet(): CancelablePromise<BaseResponse_string_> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static getUseTimesUsingGet(
        userId: number,
    ): CancelablePromise<BaseResponse_int_> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/user/get/useTimes',
            query: {
                'userId': userId,
            },
            errors: {
